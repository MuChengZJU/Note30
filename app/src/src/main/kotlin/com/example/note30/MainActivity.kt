...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Note30App(recordViewModel, historyViewModel, reminderManager)
        }
    }
}

@Composable
fun Note30App(recordViewModel: RecordViewModel, historyViewModel: HistoryViewModel, reminderManager: ReminderManager) {
    ...
    Scaffold(
        ...
        NavHost(navController = navController, startDestination = "record", modifier = Modifier.padding(innerPadding)) {
            composable("record") { RecordScreen(navController, recordViewModel, reminderManager) }
